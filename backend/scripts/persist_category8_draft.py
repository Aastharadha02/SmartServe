...
def persist_category8_draft():
    ...
    print(f"Loaded {len(services)} validated draft services for Category 8.")
    ...
    conn.close()
    print("\n" + "=" * 80)
    print(f"DONE. {success_count} Category 8 services successfully inserted/updated in PostgreSQL.")
    print("=" * 80)

if __name__ == "__main__":
    persist_category8_draft()
