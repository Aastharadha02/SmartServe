...
def persist_category2_draft():
    ...
    print(f"Loaded {len(services)} validated draft services for Category 2.")
    ...
    conn.close()
    print("\n" + "=" * 80)
    print(f"DONE. {success_count} Category 2 services successfully inserted/updated in PostgreSQL.")
    print("=" * 80)

if __name__ == "__main__":
    persist_category2_draft()
