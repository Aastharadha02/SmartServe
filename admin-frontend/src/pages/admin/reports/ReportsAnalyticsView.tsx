  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto font-sans text-slate-800">
      ...
      <div className="bg-white p-6 md:p-8 rounded-3xl border border-[#E5DEC9] shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-2xl md:text-3xl font-bold font-serif text-[#1F2A1E] tracking-tight">Reports & Analytics</h1>
        ...
        <div className="flex items-center gap-3 flex-wrap justify-end">
          <div className="flex items-center gap-2 bg-[#FAF7F0] p-1.5 rounded-2xl border border-[#E5DEC9]">
          ...
          {canExportReports ? (
            <>
              ...
              <button
                ...
                disabled={pdfLoading}
                className="px-4 py-2.5 bg-[#2F5233] hover:bg-[#3D6B42] disabled:bg-slate-300 text-white font-bold rounded-2xl text-xs flex items-center gap-1.5 shadow-xs transition-colors"
              >
            ...
            <button
              ...
              className="px-4 py-2.5 bg-[#F2EDE1] text-slate-400 font-bold rounded-2xl border border-[#E5DEC9] text-xs flex items-center gap-1.5 cursor-not-allowed opacity-70"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Total Revenue Card */}
        <div className="bg-white p-6 rounded-3xl border border-[#E5DEC9] shadow-sm space-y-2">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold font-serif text-[#1F2A1E]">
        ...
        <div className="bg-white p-6 rounded-3xl border border-[#E5DEC9] shadow-sm space-y-2">
          <div className="flex items-center justify-between">
            ...
            <span className="p-2 bg-[#F2EDE1] text-[#2F5233] rounded-2xl border border-[#E5DEC9]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 md:p-8 rounded-3xl border border-[#E5DEC9] shadow-sm space-y-6">
          <div className="flex items-center justify-between border-b border-[#E5DEC9]/60 pb-4">
            <div>
              <h3 className="text-base md:text-lg font-bold font-serif text-[#1F2A1E] flex items-center gap-2">
            ...
            <span className="text-xs font-mono font-bold text-[#2F5233] bg-[#F2EDE1] px-3 py-1 rounded-full border border-[#E5DEC9]">
              ₹{summaryData.period_revenue.toLocaleString('en-IN')} Period Total
            </span>
          </div>

          {/* Bar Chart Bars */}
          <div className="h-48 flex items-end justify-between gap-3 pt-6 px-4 border-b border-[#E5DEC9]/60">
            {summaryData.daily_trend.map((item) => {
              ...
              return (
                <div key={item.day} className="flex-1 flex flex-col items-center gap-2 group h-full justify-end">
                  ...
                  <div
                    className="w-full bg-[#2F5233]/80 group-hover:bg-[#2F5233] rounded-t-xl transition-all shadow-xs"
        ...
        {summaryData.ai_insight ? (
          <div className="bg-white p-6 rounded-3xl border border-blue-200 shadow-sm space-y-4 bg-gradient-to-b from-blue-50/50 to-white flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-700 font-medium leading-relaxed bg-white p-3.5 rounded-2xl border border-[#E5DEC9]">
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#E5DEC9] shadow-sm flex items-center justify-center text-xs text-slate-400 font-medium">
      ...
      <div className="bg-white rounded-3xl border border-[#E5DEC9] shadow-sm p-6 md:p-8 space-y-6">
        <div className="flex items-center justify-between border-b border-[#E5DEC9]/60 pb-4">
          <div>
          ...
          <span className="text-xs font-bold text-slate-600 bg-[#F2EDE1] px-3 py-1 rounded-full border border-[#E5DEC9]">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100">
              {providersData.map((p) => (
                <tr key={p.provider_id} className="hover:bg-[#FAF7F0] transition-colors">
              ...
              {servicesData.map((s, idx) => (
                <tr key={idx} className="hover:bg-[#FAF7F0] transition-colors">
                  ...
                  <td className="py-4 px-4">
                    <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-[#F2EDE1] text-[#2F5233] border border-[#E5DEC9]">
