...
def generate_report():
    draft_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "catalog_drafts", "category6", "category6_smart_home_security_DRAFT.json"))
    ...
    try:
        ...
        cur.execute("""
            ...
            WHERE category = '6. Smart Home & Security'
            AND EXISTS (
    ...
    md.append(f"- [x] Every actual Category 6 service has a complete draft ({len(services)}/{len(services)} services).")
    ...
    out_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "catalog_drafts", "category6"))
    report_path1 = os.path.join(out_dir, "category6_smart_home_security_DRAFT_REPORT.md")
    report_path2 = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "category6_smart_home_security_DRAFT_REPORT.md"))
