...
def persist_category14_draft():
    ...
    print(f"Loaded {len(services)} validated draft services for Category 14.")
    ...
    conn.close()
    print("\n" + "=" * 80)
    print(f"DONE. {success_count} Category 14 services successfully inserted/updated in PostgreSQL.")
    print("=" * 80)

if __name__ == "__main__":
    persist_category14_draft()
