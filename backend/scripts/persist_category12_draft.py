...
def persist_category12_draft():
    ...
    print(f"Loaded {len(services)} validated draft services for Category 12.")
    ...
    conn.close()
    print("\n" + "=" * 80)
    print(f"DONE. {success_count} Category 12 services successfully inserted/updated in PostgreSQL.")
    print("=" * 80)

if __name__ == "__main__":
    persist_category12_draft()
