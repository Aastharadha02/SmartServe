  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto font-sans text-slate-800">
      ...
      <div className="bg-white p-6 md:p-8 rounded-3xl border border-[#E5DEC9] shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-2xl md:text-3xl font-bold font-serif text-[#1F2A1E] tracking-tight">Settings & Configuration</h1>
      ...
      <div className="bg-white p-6 md:p-8 rounded-3xl border border-[#E5DEC9] shadow-sm space-y-4">
        <h3 className="text-base md:text-lg font-bold font-serif text-[#1F2A1E] border-b border-[#E5DEC9]/60 pb-3 flex items-center gap-2">
          <User className="w-5 h-5 text-[#2F5233]" />
          <span>Authenticated Administrator Profile</span>
        </h3>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-xs">
          <div className="p-4 bg-[#FAF7F0] rounded-2xl border border-[#E5DEC9] space-y-1">
          ...
          <div className="p-4 bg-[#FAF7F0] rounded-2xl border border-[#E5DEC9] space-y-1">
            ...
            <p className="font-bold text-[#2F5233] font-mono text-sm capitalize">{adminProfile.role_name}</p>
          </div>
        ...
        <p className="text-[11px] text-slate-400 font-semibold pt-1">
          * Account role assignments and permission scopes belong to <Link to="/admin/admins" className="text-[#2F5233] hover:underline font-bold">Admin & RBAC Management</Link>.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <form onSubmit={handlePasswordSubmit} className="bg-white p-6 md:p-8 rounded-3xl border border-[#E5DEC9] shadow-sm space-y-4">
          <h3 className="text-base font-bold font-serif text-[#1F2A1E] border-b border-[#E5DEC9]/60 pb-3 flex items-center gap-2">
            <Key className="w-5 h-5 text-[#2F5233]" />
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#FAF7F0] border border-[#E5DEC9] rounded-xl p-3 text-xs focus:outline-none focus:ring-2 focus:ring-[#2F5233]/20 focus:border-[#2F5233] font-medium"
              required
            />
          </div>
          ...
          <div className="pt-2 flex justify-end">
            <button
              ...
              className="px-5 py-2.5 bg-[#2F5233] hover:bg-[#3D6B42] text-white font-bold rounded-2xl text-xs flex items-center gap-1.5 shadow-sm transition-colors"
            >
        ...
        <div className="bg-white p-6 md:p-8 rounded-3xl border border-[#E5DEC9] shadow-sm space-y-6 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div className="p-4 bg-[#FAF7F0] rounded-2xl border border-[#E5DEC9] space-y-2">
            ...
            <div className="flex items-center gap-3">
              {!adminProfile.is_2fa_enabled ? (
                <button
                  ...
                  className="px-4 py-2 bg-[#2F5233] hover:bg-[#3D6B42] text-white font-bold rounded-xl text-xs transition-colors shadow-xs"
                >
                  Configure 2FA
                </button>
              ) : (
      ...
      {totpModalOpen && (
        <div className="fixed inset-0 z-50 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4">
          <form onSubmit={handleVerify2FACode} className="bg-white w-full max-w-md rounded-3xl shadow-xl border border-[#E5DEC9] p-6 space-y-4 animate-in fade-in">
            <div className="flex items-center justify-between border-b border-[#E5DEC9]/60 pb-3">
              <h3 className="text-base font-bold font-serif text-[#1F2A1E]">Setup Admin TOTP 2FA</h3>
