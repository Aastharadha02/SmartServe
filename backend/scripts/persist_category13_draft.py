...
def persist_category13_draft():
    ...
    print(f"Loaded {len(services)} validated draft services for Category 13.")
    ...
    conn.close()
    print("\n" + "=" * 80)
    print(f"DONE. {success_count} Category 13 services successfully inserted/updated in PostgreSQL.")
    print("=" * 80)

if __name__ == "__main__":
    persist_category13_draft()
