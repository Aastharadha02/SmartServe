...
def generate_report():
    draft_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "catalog_drafts", "category1", "category1_beauty_salon_spa_DRAFT.json"))
    ...
    try:
        ...
        cur.execute("""
            ...
            WHERE category = '1. Beauty, Salon & Spa'
            AND EXISTS (
    ...
    md = []
    md.append("# Category 1: Smart Home & Security - Draft Validation Report\n")
    ...
    md.append(f"- [x] Every actual Category 1 service has a complete draft ({len(services)}/{len(services)} services).")
    ...
    out_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "catalog_drafts", "category1"))
    report_path1 = os.path.join(out_dir, "category1_beauty_salon_spa_DRAFT_REPORT.md")
    report_path2 = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "category1_beauty_salon_spa_DRAFT_REPORT.md"))
