...
def generate_report():
    ...
    md = []
    md.append("# Category 8: Education, Teachers & Coaching - Draft Validation Report\n")
    ...
    md.append(f"- [x] Every actual Category 8 service has a complete draft ({len(services)}/{len(services)} services).")
    ...
    out_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "catalog_drafts", "category8"))
    report_path1 = os.path.join(out_dir, "category8_education_coaching_DRAFT_REPORT.md")
    report_path2 = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "category8_education_coaching_DRAFT_REPORT.md"))
